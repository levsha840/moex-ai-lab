...
> Реестр синхронизирован с `docs/40_PHASE_4_BASELINE.md §9` (2026-06-27).
...
| OQ-007 | Порог 0.80 в `session.py`: дублирует `ValidationReportBuilder._PASS_THRESHOLD`; рассмотреть `pass_threshold` в `ResearchSessionConfig` | **4.4** | Open |
